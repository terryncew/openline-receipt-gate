...
# Do not register Jain test cases in core-only discovery. The release gate
# maintains exact skip accounting for its own optional integrations, while the
# dedicated Jain workflow installs the pinned scientific dependencies and runs
# this class normally.
if HAS_JAIN_DEPS:
