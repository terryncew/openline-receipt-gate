"""JEV-WITNESS-VERCEL-002 frozen acceptance cases V1-V5.
...
"questions": ..., "providerOptions": {"gateway": {"zeroDataRetention":
true}}}. Request id from providerMetadata.gateway.generationId when present.
...
def main() -> int:
    ...
    admit_projection(
        view,
        {
            ...
            "projection_id": "jev-witness-vercel-002/v1/active",
            "issuer_id": "operator",
    ...
    admit_projection(
        ...
        {
            "schema": STANDING_PROJECTION_SCHEMA,
            "projection_id": "jev-witness-vercel-002/v1/revoke",
            "issuer_id": "operator",
            "support_hash": support_v1,
            "action_hash": action_hash_v1,
            "standing": "INACTIVE",
    ...
    if v1_committed:
        admit_projection(
            ...
            {
                "schema": STANDING_PROJECTION_SCHEMA,
                "projection_id": "jev-witness-vercel-002/v1/restore",
                "issuer_id": "operator",
                "support_hash": support_v1,
                "action_hash": action_hash_v1,
                "standing": "ACTIVE",
    ...
    return 0 if terminal in ("PASS_JEV_WITNESS_VERCEL_002", "BELOW_RECEIVER_THRESHOLD") else 1
