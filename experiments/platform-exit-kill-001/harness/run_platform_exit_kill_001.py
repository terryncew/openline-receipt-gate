...
EXP = REPO / "experiments" / "platform-exit-kill-001"
...
class Driver:
    def __init__(self, run_dir: Path) -> None:
        ...
        self.log("driver_init", baseline="3a4501c", run_now=gp.iso(self.run_now))
    ...
    def run(self) -> None:
        ...
        if failure:
            raise SystemExit(f"PLATFORM-EXIT-KILL-001 driver failed: {failure}")
